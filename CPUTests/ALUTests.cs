...
namespace CPUTests
{
    public class ALUTests
    {
        ...
        public void XOR_modifiesFlagsCorrectlyAndChangesA(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.XOR(ref A, B);
        ...
        public void NOT_flipsAllBitsCorrectly_andModifiesFlagZCorrectly(ushort A, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.NOT(ref A);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void AND_changesACorrectly_andOnlyAffectzZFlag(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.AND(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void OR_changesACorrectly_andOnlyAffectzZFlag(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.OR(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void SHL_shiftsCorrectly_andAffectsFlagCZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.SHL(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void SHR_shiftsCorrectly_andAffectsFlagCZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.SHR(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void DIV_changesAcorrectly_andAffectsFlagZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.DIV(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void MUL_changesAcorrectly_andAffectsFlagCZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.MUL(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void SUB_changesAcorrectly_andAffectsFlagCZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.SUB(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
        ...
        public void ADD_changesAcorrectly_andAffectsFlagCZ(ushort A, ushort B, ushort expected_A, ALU.FLAG expected_flags = ALU.FLAG.OFF)
        {
            alu.ADD(ref A, B);
            Assert.Equal(A, expected_A);
            AssertFlags(alu, expected_flags);
